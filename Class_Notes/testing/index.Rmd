...
#need the error=TRUE in line above so the code will die if what you're doing isn't true (ie: giv you the error message and thenstop computing)
library(testthat)
library(devtools)
...
This will set up a testing framework for you: just simple multiplication it seems like
usethis::use_test()