...
computediversity_mod = function(species) {
...
num_rare = length(summary(tmp2))

# output from function
return(list(num=nspecies, simpson=diversity, dominant=dominant, rare= rare, num_rare = num_rare))
}
